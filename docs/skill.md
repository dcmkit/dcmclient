...
| → NRRD / MetaImage (3D Slicer · ITK · nnU-Net) | `dcm2nrrd` · `dcm2mha` · `seg2nrrd` (SEG→named `.seg.nrrd`) |
...
- A companion Python package covers the same imaging engine for agents that write
